...
know the answer should be. We can use the `rnorm()` function to help
here:
...
![](lab07_BIMM143_files/figure-commonmark/unnamed-chunk-1-1.png)
...
![](lab07_BIMM143_files/figure-commonmark/unnamed-chunk-3-1.png)
...
To gert at the results of the returned list object we can use the dollar
`$` syntax
...
![](lab07_BIMM143_files/figure-commonmark/unnamed-chunk-8-1.png)
...
![](lab07_BIMM143_files/figure-commonmark/unnamed-chunk-9-1.png)
...
![](lab07_BIMM143_files/figure-commonmark/unnamed-chunk-11-1.png)

``` r
n <- NULL
for(i in 1:5){
  n <- c(n, kmeans(x, center = i)$tot.withinss)
}

plot(n, typ = "b")
```

![](lab07_BIMM143_files/figure-commonmark/unnamed-chunk-12-1.png)
...
![](lab07_BIMM143_files/figure-commonmark/unnamed-chunk-14-1.png)
...
![](lab07_BIMM143_files/figure-commonmark/unnamed-chunk-18-1.png)
...
![](lab07_BIMM143_files/figure-commonmark/unnamed-chunk-22-1.png)

``` r
barplot(as.matrix(x), col=rainbow(nrow(x)))
```

![](lab07_BIMM143_files/figure-commonmark/unnamed-chunk-23-1.png)
...
![](lab07_BIMM143_files/figure-commonmark/unnamed-chunk-24-1.png)

> Main point: It can be difficult to spot major trends and patterns even
> in relatively small multivariate dataset (here we only have 17
> dimensinos, typically we have 1000s).
...
![](lab07_BIMM143_files/figure-commonmark/unnamed-chunk-27-1.png)
...
![](lab07_BIMM143_files/figure-commonmark/unnamed-chunk-29-1.png)
...
![](lab07_BIMM143_files/figure-commonmark/unnamed-chunk-30-1.png)
