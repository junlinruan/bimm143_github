...
To see how this works let's first makeup some data to cluster where we know the answer should be. We can use the `rnorm()` function to help here:
...
To gert at the results of the returned list object we can use the dollar `$` syntax
...
> Main point: It can be difficult to spot major trends and patterns even in relatively small multivariate dataset (here we only have 17 dimensinos, typically we have 1000s).
